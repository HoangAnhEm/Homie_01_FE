...
export default function ResetPasswordPage() {
    ...
    const handleSubmit = () => {
        ...
        console.log("Thông tin mật khẩu:", {
            password,
            confirmPassword
        });
        ...
        setTimeout(() => {
            setLoading(false);
            alert("Đổi mật khẩu thành công!\n" + JSON.stringify({ password, confirmPassword }, null, 2));
            router.push({
                pathname: '/auth/login',
            });
        }, 2000);
    ...
    return (
        <AuthenLayout>
            <div className="w-2/5 max-w-md">
                <h2 className="font-bold text-3xl mb-2 text-left">Đặt lại mật khẩu</h2>
                <div className="text-black-500 font-normal mb-8 text-left">Đặt lại mật khẩu của bạn.</div>
