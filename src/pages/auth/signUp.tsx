    ...
    <div className="h-screen flex items-center justify-center relative">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center min-h-screen">
        <div className="w-2/5 max-w-md">
          ...
          <button
            type="submit"
            className={`w-full bg-[#4169E1] hover:bg-[#274c92] text-white font-semibold rounded-md px-4 py-2 transition text-[15px] cursor-pointer flex items-center justify-center ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
            disabled={loading}
